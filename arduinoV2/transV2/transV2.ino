...
const int charGap = dotDuration * 6; // time gap between each character 6
const int frequency = 900; // frequency of the sound played by the buzzer 900
...
void setup() {
  ...
  Serial.println("Wait...");
  delay(5000);
  digitalWrite(ledTransPin, HIGH); // turns on the LED
...
void loop() {
  ...
  if (Serial.available())
  {
    ...
    Serial.println("Sending..."); // signals beginning of transmission
