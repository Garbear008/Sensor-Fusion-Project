...
const int lightPeriod = 2;  // delay in milliseconds between each bit during light transmission
...
const int dotDuration = 100;               // duration in microseconds for a "dot" (represents 0)
...
const long fourDotDuration = 2000;                  // duration for "0" in 4-bit grouped sound transmission
const long fourDashDuration = fourDotDuration * 2;  // duration for "1" in 4-bit grouped sound transmission

const long bitGap = fourDotDuration * 2;  // microseconds delay between consecutive bits
